const schedule = {
  ...
  "Tuesday": [
    { number: 1, subject: { ua: "Українська література", pl: "Ukraińska literatura" }, time: "9:00 - 9:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "9:45 - 9:55" },
    ...
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "12:40 - 13:00" },
    { number: 5, subject: { ua: "Українська література", pl: "Ukraińska literatura" }, time: "13:00 - 13:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "13:45 - 13:55" },
    { number: 6, subject: { ua: "Англійська мова", pl: "Język angielski" }, time: "13:55 - 14:40" }
  ],
  "Wednesday": [
    ...
    { number: 7, subject: { ua: "Англійська мова", pl: "Język angielski" }, time: "14:50 - 15:35" },
  ],
  "Thursday": [
