...
.ch-time{font-size:.7rem;color:#aaa;flex-shrink:0;}
    ...
    .bk-build{margin-top:8px;font-size:.66rem;color:#9fa8da;text-align:right;}
    ...
    .alt-build{margin-top:8px;font-size:.66rem;color:#b39ddb;text-align:right;}
...
<div id="hw-copy-modal" class="modal-overlay">
  <div class="modal-content" style="max-width:400px;text-align:left;">
    ...
    <p style="font-size:.84rem;color:#555;margin:0 0 4px 0;">Предмет:
      <select id="hw-copy-subject" class="act-subj" onchange="openHwCopy()"></select></p>
