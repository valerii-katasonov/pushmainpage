...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    input[type=email],input[type=password],input[type=text],input[type=number],input[type=search],input[type=date],input[type=month],input:not([type]),select,textarea{width:100%;max-width:100%;min-width:0;padding:11px;margin-top:4px;border:1px solid #ccc;border-radius:11px;font-family:inherit;font-size:.95rem;}
...
.ch-time{font-size:.7rem;color:#aaa;flex-shrink:0;}
    ...
    .hw-audio{flex:1 1 100%;min-width:0;max-width:430px;padding:9px 11px;
              background:#f4f9ff;border:1px solid #cfe0f5;border-radius:10px;}
    .hw-audio>span{display:block;margin-bottom:6px;font-size:.76rem;font-weight:700;
                   color:#2b5aa8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
    .hw-audio audio{display:block;width:100%;max-width:100%;height:38px;}
    .hw-audio-preview{margin-top:7px;}
    .hw-audio-preview:empty{display:none;}
    ...
    @media (pointer: coarse) {
      input[type=text], input[type=email], input[type=password], input[type=number], input[type=search], input[type=date], input[type=month], input:not([type]), select, textarea { font-size: 16px !important; }
    ...
    @media (max-width: 480px) {
      ...
      input[type=email], input[type=password], input[type=text], input[type=number], input[type=search], input[type=date], input[type=month], input:not([type]), select, textarea { padding: 10px; font-size: 15px; }
      /* Profile bar — compact */
...
.mb-box{background:#f4fbf5;border:1px solid #c8e6c9;border-radius:14px;padding:14px;min-width:0;max-width:100%}.mb-person-pick{display:flex;gap:8px;min-width:0}.mb-person-pick select{min-width:0;margin-top:0;text-overflow:ellipsis}.mb-person-pick #k-balance-class{flex:1}.mb-person-pick #k-balance-student{flex:2}.mb-head{background:#e8f5e9;border-radius:12px;padding:14px;color:#256029;min-width:0;overflow-wrap:anywhere}.mb-head.bad{background:#ffebee;color:#b71c1c}.mb-head.low{background:#fff8e1;color:#8a6d00}.mb-head span,.mb-head small{display:block}.mb-head b{display:block;font-size:1.75rem;margin:4px 0}.mb-pending{margin-top:9px;padding:10px;border-radius:9px;background:#fff8e1;font-size:.8rem;color:#795d00}.mb-note{margin:10px 0;font-size:.76rem;color:#677;overflow-wrap:anywhere}.mb-form{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px;margin-top:12px;min-width:0}.mb-form>*{min-width:0;max-width:100%}.mb-form label{font-size:.7rem;color:#657;font-weight:700;overflow-wrap:anywhere}.mb-form input,.mb-form button{margin:3px 0 0;width:100%}.mb-form button,.mb-form small{grid-column:1/-1}.mb-form small{font-size:.7rem;color:#777;overflow-wrap:anywhere}.mb-history{margin-top:12px;min-width:0}.mb-history summary{cursor:pointer;font-weight:700;color:#356b3a;overflow-wrap:anywhere}.mb-history>div{display:grid;grid-template-columns:85px 90px minmax(0,1fr);gap:7px;padding:7px 0;border-bottom:1px solid #e0ece1;font-size:.76rem}.mb-history>div>*{min-width:0;overflow-wrap:anywhere}.mb-history b{color:#2e7d32}.mb-history b.neg{color:#c62828}.mb-history small{color:#777}
@media(max-width:30em){.mb-person-pick{flex-direction:column}.mb-form{grid-template-columns:minmax(0,1fr)}.mb-form button,.mb-form small{grid-column:1}.mb-history>div{grid-template-columns:72px 78px minmax(0,1fr)}.k-prices-grid{grid-template-columns:minmax(0,1fr)}}
</style>
</head>
...
<div class="container">
  ...
  <div id="kitchen-screen" class="panel">
    ...
    <section class="screen-section">
      <h3>💳 Баланс харчування</h3>
      <div class="data-card" style="border-left-color:#2e7d32;margin-top:0;">
        <p style="font-size:.76rem;color:#777;margin-top:0;">Внесіть надходження з банківського рахунку. Перша дата «рахувати від» відкриває особовий рахунок.</p>
        <div class="mb-person-pick">
          <select id="k-balance-class" onchange="loadMealAccountStudents()"><option value="">Клас...</option><option value="class_1">1 клас</option><option value="class_2">2 клас</option><option value="class_3">3 клас</option><option value="class_4">4 клас</option><option value="class_5">5 клас</option><option value="class_6">6 клас</option><option value="class_7">7 клас</option><option value="class_8">8 клас</option><option value="class_9">9 клас</option><option value="class_10">10 клас</option><option value="class_11">11 клас</option></select>
          <select id="k-balance-student" onchange="loadKitchenMealAccount()"><option value="">Оберіть дитину...</option></select>
        </div>
        <div id="k-meal-balance"><p class="empty-msg">Оберіть клас і дитину.</p></div>
      </div>
    </section>
  ...
  <div id="director-screen" class="panel">
    ...
    <section class="screen-section" data-dtab="workload">
      ...
      <div class="ma-filters">
        <input type="date" id="d-workload-week" aria-label="Тиждень" onchange="loadDirectorWorkload()" style="width:auto;">
        <input type="search" id="d-workload-search" placeholder="Знайти вчителя" aria-label="Знайти вчителя" oninput="renderWorkload()">
        <button type="button" onclick="loadDirectorWorkload()">Оновити</button>
      </div>
...
<details data-dtab="nalash" style="background:#e8f5e9;padding:14px;border-radius:12px;border:1px solid #a5d6a7;">
      ...
      <details data-dtab="nalash" style="background:#fdf2e9;padding:14px;border-radius:12px;border:1px solid #f5cba7;" ontoggle="if(this.open)loadGradeTypesAdmin()">
        ...
        <div style="margin-top:13px;">
          ...
          <div style="display:flex;gap:7px;margin-top:12px;flex-wrap:wrap;">
            <input type="text" id="gt-new-code" placeholder="Код (напр. ЛР)" style="width:90px;margin:0;">
            <input type="text" id="gt-new-label" placeholder="Назва" style="flex:1;min-width:140px;margin:0;">
    ...
    <section class="screen-section" data-dtab="lesson">
      ...
      <div id="t-hw-input-wrapper">
        ...
        <input type="file" id="t-image" class="hw-file-input"
               accept="image/*,audio/*,.doc,.docx,.xls,.xlsx,.csv,.mp3,.m4a,.wav,.ogg,.oga,.aac,.flac,.webm,.opus" multiple
        ...
        <div id="hw-audio-preview" class="hw-audio-preview"></div>
        <p class="hw-file-hint">Можна: фото, аудіо (MP3, M4A, WAV, OGG, AAC), документ
          (DOC, DOCX) або таблиця (XLS, XLSX, CSV). До 10 МБ на файл.</p>
      ...
      <div style="margin-top:13px;background:#fffcf0;padding:14px;border-radius:12px;border:1px solid #fde3a7;">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:flex-end;">
          ...
          <label style="flex:1;min-width:140px;font-size:.74rem;color:#d35400;font-weight:600;">Предмет
            <select id="t-sticker-subject" style="margin-top:3px;" onchange="toggleStickerOther()"></select>
          </label>
        ...
        <label id="t-sticker-other-wrap" style="display:none;margin-top:9px;font-size:.74rem;color:#d35400;font-weight:600;">За що наліпка?
          <input type="text" id="t-sticker-other" maxlength="160" placeholder="Наприклад, допоміг однокласнику" style="margin-top:3px;border-color:#f1c40f;">
        </label>
      </div>
      <!-- Коментар -->
  ...
  <div id="parent-screen" class="panel">
    ...
    <section class="screen-section" data-dtab="meals">
      ...
      <h3 style="margin-top:18px;">💳 Баланс харчування</h3>
      <div id="p-meal-balance" class="mb-box"><p class="empty-msg">Рахуємо...</p></div>
    </section>
    ...
    <section class="screen-section" data-dtab="grades">
      <div class="data-card" style="border-left-color:#f1c40f;background:#fffcf0;text-align:center;margin-top:0;">
        ...
        <div id="p-sticker-history" style="margin-top:12px;text-align:left;"></div>
      </div>
    </section>
  ...
  <div id="student-screen" class="panel">
    ...
    <section class="screen-section" data-dtab="study">
      ...
      <div class="data-card" style="border-left-color:#f1c40f;background:#fffcf0;text-align:center;margin-top:0;">
        ...
        <div id="s-sticker-history" style="margin-top:12px;text-align:left;"></div>
      </div>
      <!-- Підручники -->
...
<!-- Швидке створення гуртка з конструктора розкладу -->
<div id="quick-club-modal" class="modal-overlay" style="z-index:1003;">
  <div class="modal-content" style="max-width:410px;">
    <h3 style="margin-top:0;color:#2e7d32;">🎨 Створити гурток</h3>
    <p id="qcc-class-label" style="font-size:.8rem;color:#687b72;"></p>
    <label for="qcc-name">Назва гуртка:</label>
    <input type="text" id="qcc-name" maxlength="80" placeholder="Наприклад, Робототехніка">
    <label for="qcc-teacher">Учитель:</label>
    <select id="qcc-teacher"><option value="">— учителя не призначено —</option></select>
    <p id="qcc-error" style="display:none;color:var(--red);font-size:.78rem;"></p>
    <div style="display:flex;gap:9px;margin-top:14px;">
      <button type="button" id="qcc-save" onclick="saveQuickClub()" style="background:#2e7d32;color:#fff;">Створити й вибрати</button>
      <button type="button" onclick="closeQuickClubCreator()" style="background:#eef2f0;color:#465b54;">Скасувати</button>
    </div>
  </div>
</div>
...
<script type="module" src="parent-student.js?v=20260915-1"></script>
<script type="module" src="teacher.js?v=20260915-2"></script>
<script type="module" src="kitchen.js?v=20260915-3"></script>
<script type="module" src="meal-balance.js?v=20260915-3"></script>
...
<script type="module" src="workload.js?v=20260915-2"></script>
<script type="module" src="clubs-catalog.js?v=20260915-3"></script>
