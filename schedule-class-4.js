...
const schedule = {
  ...
  Tuesday: [
    ...
    { number: " ", subject: { ua: "Обід 1-4 класи", pl: "Obiad klasy 1-3" }, time: "11:35 - 11:55" },
    { number: 4, subject: { ua: "Edukacja wczesnoszkolna", pl: "Edukacja wczesnoszkolna" }, time: "11:55 - 12:40" },
    { number: " ", subject: { ua: "Обід 5-6 класи", pl: "Obiad klasy 4-5" }, time: "12:40 - 13:00" },
    { number: 5, subject: { ua: "Plastyka/Tehnika", pl: "Plastyka/Tehnika" }, time: "13:00 - 13:45" },
  ...
  Wednesday: [
    ...
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "13:45 - 13:55" },
    { number: 6, subject: { ua: "Фізична культура/Музика", pl: "Wychowanie fizyczne/Muz" }, time: "13:55 - 14:40" }
  ],
  Thursday: [
    { number: 1, subject: { ua: "Англійська мова", pl: "Język angielski" }, time: "9:00 - 9:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "9:45 - 9:55" },
    { number: 2, subject: { ua: "Edukacja wczesnoszkolna", pl: "Edukacja wczesnoszkolna" }, time: "9:55 - 10:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "10:40 - 10:50" },
  ...
  Friday: [
    ...
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "9:45 - 9:55" },
    { number: 2, subject: { ua: "Читання", pl: "Czytanie" }, time: "9:55 - 10:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "10:40 - 10:50" },
    { number: 3, subject: { ua: "Edukacja wczesnoszkolna", pl: "Edukacja wczesnoszkolna" }, time: "10:50 - 11:35" },
