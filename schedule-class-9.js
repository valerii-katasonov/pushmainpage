const schedule = {
  "Monday": [
    ...
    { number: 2, subject: { ua: "Хімія", pl: "Chemia" }, time: "9:55 - 10:40" },
    ...
    { number: 4, subject: { ua: "Географія", pl: "Geografia" }, time: "11:55 - 12:40" },
    ...
    { number: 6, subject: { ua: "Алгебра", pl: "Algebra" }, time: "13:55 - 14:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "14:40 - 14:50" },
    { number: 7, subject: { ua: "Фізика", pl: "Fizyka" }, time: "14:50 - 15:35" }
  ],
  "Tuesday": [
    { number: 1, subject: { ua: "Історія України", pl: "Historia Ukrainy" }, time: "9:00 - 9:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "9:45 - 9:55" },
    ...
    { number: 5, subject: { ua: "Англійська мова", pl: "Język angielski" }, time: "13:00 - 13:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "13:45 - 13:55" },
    { number: 6, subject: { ua: "Всесвітня історія", pl: "Historia powszechna" }, time: "13:55 - 14:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "14:40 - 14:50" },
    { number: 7, subject: { ua: "Українська література", pl: "Ukraińska literatura" }, time: "14:50 - 15:35" }
  ],
  "Wednesday": [
    { number: 1, subject: { ua: "Інформатика", pl: "Informatyka" }, time: "9:00 - 9:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "9:45 - 9:55" },
  ...
  "Thursday": [
    ...
    { number: 2, subject: { ua: "Українська мова", pl: "Język ukraiński" }, time: "9:55 - 10:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "10:40 - 10:50" },
    { number: 3, subject: { ua: "Історія Польщі", pl: "Historia Polski" }, time: "10:50 - 11:35" },
    { number: " ", subject: { ua: "Обід", pl: "Obiad" }, time: "11:35 - 11:55" },
    { number: 4, subject: { ua: "Геометрія", pl: "Geometria" }, time: "11:55 - 12:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "12:40 - 13:00" },
    { number: 5, subject: { ua: "Фізична культура", pl: "Wychowanie fizyczne" }, time: "13:00 - 13:45" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "13:45 - 13:55" },
    { number: 6, subject: { ua: "Фізична культура", pl: "Wychowanie fizyczne" }, time: "13:55 - 14:40" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "14:40 - 14:50" },
    { number: 7, subject: { ua: "Основи права", pl: "Podstawy prawa" }, time: "14:50 - 15:35" },
    { number: " ", subject: { ua: "Перерва", pl: "Przerwa" }, time: "15:35 - 15:45" },
    { number: 8, subject: { ua: "Англійська мова", pl: "Język angielski" }, time: "15:45 - 16:30" }
  ],
  "Friday": [
