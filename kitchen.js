...
//
// Кнопка підвечірка жила під дедлайном ОБІДУ й зникала разом з обідньою,
// а замість неї ставав замок із текстом про обіди — до підвечірка він
// стосунку не мав. Спершу я поставив тут 12:00, припустивши, що
// підвечірок замовляють пізніше. Кухня сказала інакше: продукти на день
// рахують один раз зранку, тож межа та сама — 9:00.
//
// Окрему сталу лишаємо навмисно: текст замка свій («підвечірок», а не
// «обіди»), і якщо кухня колись розведе ці години, міняти доведеться одне
// число, а не шукати, де саме підвечірок сплутали з обідом.
